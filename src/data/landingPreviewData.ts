...
export const landingPreviewData = {
  initiatives: [
    ...
    { id: 'v1', name: 'Kundeportal 2.0', dimension: 'virksomhet' as const, horizon: 'near' as const, status: 'active' as const },
    ...
    { id: 't1', name: 'Skymigrering fase 2', dimension: 'teknologi' as const, horizon: 'near' as const, status: 'active' as const },
    ...
    { id: 't9', name: 'Sikkerhetsprogram', dimension: 'teknologi' as const, horizon: 'near' as const, status: 'active' as const },
  ],
  capabilities: [
